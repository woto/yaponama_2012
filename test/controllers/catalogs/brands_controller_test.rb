...
class Catalogs::BrandsControllerTest < ActionController::TestCase
  ...
  test 'Быстрый тест на содержание страницы 235245' do
    ...
    assert_select '.page-header', 'Запчасти на MITSUBISHI (рус. Митсубиси, Митсубиши)Вступление'
    assert_select '.breadcrumb', /^Каталог.*MITSUBISHI$/m
    assert_select '.by-car #catalog-models', /^Запчасти на MITSUBISHI Galant \(4 шт.\)\s+Запчасти на MITSUBISHI Lancer \(3 шт.\)\s+Запчасти на MITSUBISHI Lancer Ralliart \(2 шт.\)$/m
    #TODO Переработать
