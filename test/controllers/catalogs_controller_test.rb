...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test 'Быстрый тест на содержание страницы 23489' do
    ...
    assert_select '.brands', /Запчасти на BRAND1 \(1 шт.\)\s+Запчасти на BRAND2 \(1 шт.\)\s+Запчасти на KI \(1 шт.\)\s+Запчасти на MITSUBISHI \(10 шт.\)\s+Запчасти на TOYOTA \(8 шт.\)/m
  end
