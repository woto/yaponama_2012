...
ActiveRecord::Schema.define(version: 20150528104139) do
  ...
  create_table "spare_infos", force: :cascade do |t|
    ...
    t.string   "title"
    t.integer  "spare_info_phrase_id"
  end
  ...
  add_index "spare_infos", ["spare_info_phrase_id"], name: "index_spare_infos_on_spare_info_phrase_id", using: :btree
  ...
  add_foreign_key "spare_infos", "spare_info_phrases"
end
