...
class Catalogs::BrandsControllerTest < ActionController::TestCase
  ...
  test 'Быстрый тест на содержание страницы 235245' do
    ...
    assert_select '#catalogs-brands-show-models', /^Запчасти на MITSUBISHI Galant \(5 шт.\)\s+Запчасти на MITSUBISHI Lancer \(3 шт.\)\s+Запчасти на MITSUBISHI Lancer Ralliart \(2 шт.\)$/m
    #TODO Переработать
