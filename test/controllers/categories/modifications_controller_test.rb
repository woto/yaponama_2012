...
class Categories::ModificationsControllerTest < ActionController::TestCase
  ...
  test 'Быстрый тест на содержание страницы 23489543' do
    ...
    assert_select '.breadcrumb', /^Категории\s+САЙЛЕНТБЛОК\s+MITSUBISHI\s+Galant\s+2008 - 2013, 9 поколение \[2-й рестайлинг\]\s+CN седан 4-дв. 2.0 AT \(160 л. с.\)$/m
    assert_select '#best-parts-list', '2102 (NISSAN) САЙЛЕНТБЛОК'
  end
