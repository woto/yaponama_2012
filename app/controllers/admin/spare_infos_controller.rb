class Admin::SpareInfosController < Admin::ApplicationController
  # GET /admin/spare_infos
  # GET /admin/spare_infos.json
  def index
    @admin_spare_infos = Admin::SpareInfo.all
  ...
  def show
    @admin_spare_info = Admin::SpareInfo.find(params[:id])
  ...
  def new
    @admin_spare_info = Admin::SpareInfo.new
  ...
  def create
    @admin_spare_info = Admin::SpareInfo.new(params[:admin_spare_info])

    respond_to do |format|
      if @admin_spare_info.save
        format.html { redirect_to @admin_spare_info, notice: 'Spare info was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @admin_spare_info.update_attributes(params[:admin_spare_info])
        format.html { redirect_to @admin_spare_info, notice: 'Spare info was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_spare_infos_url }
      format.json { head :no_content }
    end
  end
end
