class RobokassaController < ApplicationController
  ...
  def success
    notify = Robokassa.notification request.raw_post, :secret => Rails.configuration.active_merchant['pass1']
  ...
  def result
    notify = Robokassa.notification request.raw_post, :secret => Rails.configuration.active_merchant['pass2']
