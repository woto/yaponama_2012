...
class Admin::ProfilesControllerTest < ActionController::TestCase
  ...
  test 'Если создаем и не ставим галочку подтверждения' do
    assert_difference 'Phone.count' do
      post :create, 'profile' => {
        ...
        'phones_attributes' => {
          '0' => {
            'value' => '+7 (492) 354-29-51', 'mobile' => '1', 'confirmed' => '0', '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
           user_id: @user.id
    end
  ...
  test 'Если создаем и ставим галочку подтверждения' do
    assert_difference 'Phone.count' do
      post :create, 'profile' => {
        ...
        'phones_attributes' => {
          '0' => {
            'value' => '+7 (491) 392-12-42', 'mobile' => '1', 'confirmed' => '1', '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
           user_id: @user.id
    end
  ...
  test 'Если создаем не мобильный и не ставим подтверждение' do
    assert_difference 'Phone.count' do
      post :create, 'profile' => {
        ...
        'phones_attributes' => {
          '0' => {
            'value' => '+7 (492) 354-29-51', 'mobile' => '0', '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
           user_id: @user.id
    end
  ...
  test 'Если не существенно меняется и подтверждено' do
    patch :update, 'profile' => {
      'emails_attributes' => {
        '0' => {
          'value' => 'FaKe@example.com', 'id' => @confirmed_email.id}}},
          'id' => @confirmed_email.profile.id, 'user_id' => @user.id
  ...
  test 'Если не существенно меняется и не подтверждено' do
    patch :update, 'profile' => {
      'emails_attributes' => {
        '0' => {
          'value' => 'FoO@example.com', 'id' => @not_confirmed_email.id, '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
          'id' => @not_confirmed_email.profile.id, 'user_id' => @user.id
  ...
  test 'Если существенно изменяется подтвержденный и убираем галочку подтверждения' do
    patch :update, 'profile' => {
      'phones_attributes' => {
        '0' => {
          'value' => '+7 (666) 666-66-66', 'confirmed' => '0', 'id' => @confirmed.id, '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
          'id' => @confirmed.profile.id, 'user_id' => @user.id
  ...
  test 'Если существенно изменяется не подтвержденный, и ставим галочку подтверждения' do
    patch :update, 'profile' => {
      'phones_attributes' => {
        '0' => {
          'value' => '+7 (666) 666-66-66', 'confirmed' => '1', 'id' => @not_confirmed.id, '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
          'id' => @not_confirmed.profile.id, 'user_id' => @user.id
  ...
  test 'Если существенно меняется подтвержденный и сохраняем выставленную галочку (не отправляем в запросе, что равносильно выставлению)' do
    patch :update, 'profile' => {
      'phones_attributes' => {
        '0' => {
          'value' => '+7 (666) 666-66-66', 'id' => @confirmed.id, '_confirm_required' => 'BAhG--f08ccee0690fe187cfb33d7685f891fd3266d23d'}}},
          'id' => @confirmed.profile.id, 'user_id' => @user.id
