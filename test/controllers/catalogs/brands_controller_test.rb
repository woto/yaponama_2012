...
class Catalogs::BrandsControllerTest < ActionController::TestCase
  ...
  test 'Быстрый тест на содержание страницы 235245' do
    ...
    assert_select '.page-header', 'Запчасти на MITSUBISHI (рус. Митсубиси, Митсубиши)Mitsubishi Motors Corporation — японская автомобилестроительная компания, входит в группу Mitsubishi — являющейся самой большой производственной группой Японии. Штаб-квартира — в Токио'
