...
class SplitTest < ActionDispatch::IntegrationTest
  ...
  test "Разбитие товара на партии. Проверяем количество товарных транзакций и денежных" do
    ...
    pt = ProductTransaction.count
    at = AccountTransaction.count
    ...
    assert_equal 3, ProductTransaction.count - pt, 'Должно было быть 3. 1 - удаление и 2 - создания'
    assert_equal 0, AccountTransaction.count - at, 'Деньги не изменились'
  end
